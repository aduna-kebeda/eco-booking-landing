...
const BookingForm = () => {
  ...
  return (
    <section id="booking-form" className="py-16 md:py-24 bg-gradient-to-br from-primary-50 to-secondary-50">
            ...
            <div className="lg:col-span-2">
              <Card className="shadow-lg border-0">
                <CardHeader className="bg-white rounded-t-lg">
                  <CardTitle className="text-2xl text-gray-900">Book Your Inspection</CardTitle>
                  <p className="text-gray-600">Fill out the details below and we'll contact you within 2 hours.</p>
                </CardHeader>
                <CardContent className="p-6 bg-white rounded-b-lg">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-700">Pest Issue</label>
                ...
                <CardContent className="p-6 bg-white">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">0400 123 456</p>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">info@ecovia.com.au</p>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">All Sydney Areas</p>
                        <p className="text-sm text-gray-600">Free travel within 30km of CBD</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">Mon-Fri: 7am-7pm</p>
                        <p className="text-sm text-gray-600">Sat-Sun: 8am-5pm</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-accent-500 text-white rounded-full flex items-center justify-center text-sm font-bold">1</div>
                      <div>
                        <p className="font-medium text-gray-900">Quick Response</p>
                        <p className="text-sm text-gray-700">We'll contact you within 2 hours to confirm your appointment</p>
                      </div>
                    </div>
                    
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-accent-500 text-white rounded-full flex items-center justify-center text-sm font-bold">2</div>
                      <div>
                        <p className="font-medium text-gray-900">Thorough Inspection</p>
                        <p className="text-sm text-gray-700">Comprehensive property assessment with thermal imaging</p>
                      </div>
                    </div>
                    
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-accent-500 text-white rounded-full flex items-center justify-center text-sm font-bold">3</div>
                      <div>
                        <p className="font-medium text-gray-900">Detailed Report</p>
                        <p className="text-sm text-gray-700">Written report with findings and treatment recommendations</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
